...
-   **How to decide on a threshold of assigning *generate_regime_change*?**

-   **New variable capturing the "formative years" -\> 18 years of age? Or younger?**
...
| Staggered: Callaway Sant' Anna | Stacked: Cengiz et al. 2019 |
|----|----|
| R package "did" | no package for implementation |
|  |  |
| Not possible to measure heterogeneity in the treatment effect along some covariates (can measure just at group level) | Can include covariates to investigate heterogeneity |
