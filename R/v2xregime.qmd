...
create_country_regime_data_vdem <- function(vdem_data,
  ...
  country_regime_changes <- vdem_data %>%
    ...
    mutate(
      ...
      # raw classification
      regime_change_raw = case_when(
        !is.na(v2x_regime_lag) & v2x_regime_lag %in% 0:1 & v2x_regime %in% 2:3 ~ 2,
        !is.na(v2x_regime_lag) & v2x_regime_lag %in% 2:3 & v2x_regime %in% 0:1 ~ 1,
        TRUE ~ 0
      ),

      # here: keep all regime changes, even repeated
      regime_change = regime_change_raw,
...
saveRDS(final_data_vdem_clean_gdp, here("Input", "clean", "final_data_vdem_clean_gdp.rds" ))
```
