...
The Table below shows the **summary statistics** of preference and controls table:
...
Our main key variable is **`TRUST.`** Here below it shows the average **`TRUST`** of countries in *2012* and *2013*.
...
Here is shows that the **Trust levels by Regime Change Exposure**
...
The following figures present a detailed **visual overview of the descriptive statistics**, including scatter plots of key variables, distribution histograms, group-level comparisons, and difference-in-differences style visualizations highlighting trends across cohorts.
