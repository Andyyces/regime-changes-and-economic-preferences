...
-   $X_i$ represents individual characteristics (subjective math skills)
...
The regime changes are identified first on a country level according to the V-Dem dataset and then combined with the individual level data from the General Preference Survey. Goal is to **differentiate between individuals who experienced a regime change during their formative years** and individuals, who didn't.
...
In this step we also differentiate between the **direction of the change**, either from **autocracy to democracy** and from **democracy to autocracy.**
