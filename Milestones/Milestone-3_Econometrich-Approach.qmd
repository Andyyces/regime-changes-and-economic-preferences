...
Our **control group** therefore consists only of **individuals from countries, which never experienced a regime change**. Applying this approach leaves us with following number of observations in each category, as shown in [@tbl-b].
