...
```{r}
#| include: false
conditional_balance <- readRDS(here("Output", "conditional_balance_table.rds"))
democratization_balance <- readRDS(here("Output", "balance_table_democratization_vs_autocratization.rds"))
overall_balance <- readRDS(here("Output", "balance_table_overall.rds"))
sample_composition <- readRDS(here("Output", "sample_composition.rds"))
```
